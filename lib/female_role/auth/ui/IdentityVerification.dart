...
class FemaleIdentityVerificationUI extends StatefulWidget {
  const FemaleIdentityVerificationUI({super.key});

  @override
  State<FemaleIdentityVerificationUI> createState() => _FemaleIdentityVerificationUIState();
}

class _FemaleIdentityVerificationUIState extends State<FemaleIdentityVerificationUI> {
  File? _imageFile;
  File? _videoFile;
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (_imageFile == null || _videoFile == null) {
                      ...
                      Get.toNamed(AppRoutes.femaleVerificationComplete);
                    }
                  },
