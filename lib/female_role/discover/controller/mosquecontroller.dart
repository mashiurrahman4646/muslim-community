...
class FemaleMosqueController extends GetxController {
  ...
  void _setupSocketListeners() async {
    try {
      ...
      _socketService.on('UPDATE_DISCOVERY', (data) {
        print("SOCKET_DEBUG: Discovery update received for female mosques");
        fetchNearbyMosques(isSilent: true);
      });
      _socketService.on('NEW_MOSQUE', (data) {
        print("SOCKET_DEBUG: New female mosque added");
        fetchNearbyMosques(isSilent: true);
      });
    } catch (e) {
      print("Error setting up socket listeners for female mosques: $e");
    }
  }
