              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isAskTab ? AppColors.femaleColor : Colors.transparent,
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: GoogleFonts.inter(
                          ...
                          color: isAskTab ? Colors.white : AppColors.femaleColor.withOpacity(0.5),
                        ),
                      ),
                    ),
                  ),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.r),
                borderSide: BorderSide(color: AppColors.femaleColor.withOpacity(0.2), width: 1),
              ),
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(20.r),
                borderSide: const BorderSide(color: AppColors.femaleColor, width: 1.5),
              ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.auto_awesome_rounded, color: AppColors.femaleColor, size: 16.sp),
                    ),
                    SizedBox(width: 12.w),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
