...
class FemalePrayerSettingsUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final FemalePrayerSettingsController controller = Get.put(FemalePrayerSettingsController());
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.near_me_outlined, color: AppColors.femaleColor, size: 20.sp),
          ),
          SizedBox(width: 15.w),
          Expanded(
            child: Column(
  ...
  Widget _buildNotificationItem(String name, RxString status, FemalePrayerSettingsController controller, String key, {bool isLast = false}) {
    return Padding(
          ...
          GestureDetector(
            ...
            child: Obx(() {
              ...
              return Container(
                padding: EdgeInsets.symmetric(horizontal: 16.w, vertical: 8.h),
                decoration: BoxDecoration(
                  color: isOff ? Colors.grey.withOpacity(0.1) : AppColors.femaleColor.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(20.r),
                  border: Border.all(color: isOff ? Colors.grey.withOpacity(0.3) : AppColors.femaleColor.withOpacity(0.3)),
                ),
                child: Row(
