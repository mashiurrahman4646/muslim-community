...
class MaleForgetPasswordOTPUI extends StatefulWidget {
  const MaleForgetPasswordOTPUI({super.key});

  @override
  State<MaleForgetPasswordOTPUI> createState() => _MaleForgetPasswordOTPUIState();
}

class _MaleForgetPasswordOTPUIState extends State<MaleForgetPasswordOTPUI> {
