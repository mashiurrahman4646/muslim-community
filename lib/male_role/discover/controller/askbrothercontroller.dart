...
import 'package:muslim_community/male_role/discover/service/askbrotherservice.dart';
import 'package:muslim_community/services/socket_service.dart';

class AskBrotherController extends GetxController {
  final AskBrotherService _service = AskBrotherService();
  ...
  void _setupSocketListeners() async {
    try {
      ...
      print("Error setting up socket listeners for ask brother: $e");
    }
  }
