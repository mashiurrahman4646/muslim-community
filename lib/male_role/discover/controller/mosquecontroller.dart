    ...
    try {
      ...
      try {
        ...
        try {
          ...
          print("getCurrentPosition failed for mosques, trying getLastKnownPosition: $e");
        ...
        if (position != null) {
          ...
          print("Both getCurrentPosition and getLastKnownPosition returned null for mosques, using default Dhaka coordinates.");
        }
      } catch (e) {
        print("Geolocator failed for mosques, using fallback: $e");
      }
