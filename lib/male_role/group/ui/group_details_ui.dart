...
class MaleGroupDetailsUI extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Get group data from arguments if available, otherwise use a placeholder
          ...
          children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(group.icon, color: AppColors.maleColor, size: 24.sp),
                      ),
                      SizedBox(width: 15.w),
                      Expanded(
                        child: Column(
            ...
            Row(
              children: [
                CircleAvatar(
                  radius: 20.r,
                  backgroundImage: const AssetImage('assets/icons/abubakr.png'), // Placeholder
                ),
                SizedBox(width: 15.w),
                Expanded(
                  child: Container(
            ...
            Align(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFFE9DCC9), // Soft beige from image
  ...
  Widget _buildPostCard(BuildContext context) {
    return GestureDetector(
      onTap: () => Get.toNamed(AppRoutes.malePostDetails),
      child: Container(
        padding: EdgeInsets.all(20.w),
        decoration: BoxDecoration(
          color: Colors.white,
          ...
          children: [
            Row(
              children: [
                CircleAvatar(
                  radius: 18.r,
                  backgroundImage: const AssetImage('assets/icons/abubakr.png'), // Placeholder for Tariq
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Column(
