...
class MaleUserDataController extends GetxController {
  final MaleUserDataService _service = MaleUserDataService();

  var isLoading = false.obs;
  var userId = "".obs;
  var userName = "Ahmed".obs;
  ...
  Future<void> getUserData() async {
    try {
      ...
      print("Error in MaleUserDataController: $e");
    } finally {
      isLoading(false);
    }
  }
